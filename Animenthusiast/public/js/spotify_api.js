function clickSongs(event){
    ...
    fetch(API_ROUTE+"spotify/searchSpotify/"+encodedText).then(onResponse).then(jsonSongs);
}
...
const form = document.querySelector("#cerca_canzoni");
form.addEventListener('submit', clickSongs);