<html>
    ...
    <nav id="nav_style">
        <div id='menu'>
            ...
            <a href="<?php echo e(url('spotify')); ?>"><div class="sezione">MUSICA</div></a>
            <a href="<?php echo e(url('profilo')); ?>"><div class="sezione">PROFILO</div></a>
        ...
        <div id='mobile_menu'>
            <div id='sezioni_mobile'>
                ...
                <a href="<?php echo e(url('spotify')); ?>"><div class="sezione_mobile">MUSICA</div></a>
                <a href="<?php echo e(url('profilo')); ?>"><div class="sezione_mobile">PROFILO</div></a>
            </div>
        </div>
    </nav>
