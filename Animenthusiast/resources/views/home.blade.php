<html>
    ...
    <head>
        ...
        <script src="{{asset('js/likes.js')}}" defer="true"></script>
        <script type="text/javascript">
            const HOME_ROUTE = "{{url('/')}}/";
    ...
    <nav id="nav_style">
        <div id='menu'>
            ...
            <a href="{{url('spotify')}}"><div class="sezione">MUSICA</div></a>
            <a href="{{url('profilo')}}"><div class="sezione">PROFILO</div></a>
        ...
        <div id='mobile_menu'>
            <div id='sezioni_mobile'>
                ...
                <a href="{{url('spotify')}}"><div class="sezione_mobile">MUSICA</div></a>
                <a href="{{url('profilo')}}"><div class="sezione_mobile">PROFILO</div></a>
            </div>
        </div>
    </nav>
    ...
    <body>
        ...
        <section id="feed">
            ...
            <footer id='finale'> 
                <div>
                    <hr>
                        <p class="fin">{{$nome}} {{$cognome}} - anime enthusiast </p>
                </div>
            </footer>
    </body>
